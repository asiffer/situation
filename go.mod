module github.com/asiffer/situation
...
require (
	...
	github.com/Zxilly/go-size-analyzer v1.13.1 // indirect
	github.com/ZxillyFork/gore v0.0.0-20260809074232-b6a5ff0f7bed // indirect
